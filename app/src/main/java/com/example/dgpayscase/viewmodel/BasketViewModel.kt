...
@HiltViewModel
class BasketViewModel @Inject constructor(val appRepository: AppRepository) : BaseViewModel<MainContract.Event, MainContract.State<MainContract.HomeState>, MainContract.Effect>() {
